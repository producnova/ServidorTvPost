...
def formato_100():
    ...
    os.system('bash ~/TvPost/Bash_files/Screen_divitions_config/100_100.sh {} {} {} {} {} {}'.format(resolution_values[0], resolution_values[1], resolution_values[2], resolution_values[3], resolution_values[4], resolution_values[5]))
